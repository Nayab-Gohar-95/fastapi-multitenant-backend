...
async def register(
    ...
    Default role is 'user'. To create admins, use the admin-only endpoint.
    """
...
async def login(
    ...
    The token embeds tenant_id and role for stateless authorisation.
    Token lifetime is controlled by ACCESS_TOKEN_EXPIRE_MINUTES in .env.
    """
